...
/***/ function(module, exports, __webpack_require__) {
	...
	var name = "Phasit Phat";

	console.log((0, _function.sayHi)(name));

	var movieUrl = 'http://www.omdbapi.com/?t=batman&y=&plot=short&r=json';
	_axios2.default.get(movieUrl).then(function (response) {
	        console.log(response);
	});

	console.log((0, _function.sayBye)(name));
